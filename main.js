...
nasa_mars_images_array=["https://wallpapercave.com/wp/kcpnM5G.jpg"];
random_number=Math.floor(Math.random()*4);
console.log(random_number);

rover_width = 100; rover_height = 90;
background_image = nasa_mars_images_array[random_number];
 rover_image = "https://tse3.mm.bing.net/th?id=OIP.FsvJz2wAebdwIvlUXeSpTgHaDs&pid=Api&P=0&w=320&h=160";
